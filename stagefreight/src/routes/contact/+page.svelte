    ...
    <div class="max-w-lg mx-auto mb-12 p-8 bg-zinc-900 rounded-lg shadow-lg">
      ...
      <form class="space-y-6">
        <div class="mb-4">
          ...
          <input type="text" id="name" class="w-full px-4 py-2 bg-zinc-800 text-white rounded border border-zinc-600 focus:ring-2 focus:ring-red-400" placeholder="Your name" />
        </div>
        <div class="mb-4">
          <label for="email" class="block text-lg font-semibold text-red-400">Email</label>
          <input type="email" id="email" class="w-full px-4 py-2 bg-zinc-800 text-white rounded border border-zinc-600 focus:ring-2 focus:ring-red-400" placeholder="Your email address" />
        </div>
        <div class="mb-4">
          <label for="message" class="block text-lg font-semibold text-red-400">Message</label>
          <textarea id="message" class="w-full px-4 py-2 bg-zinc-800 text-white rounded border border-zinc-600 focus:ring-2 focus:ring-red-400" rows="5" placeholder="Your message"></textarea>
        </div>
    ...
    <div class="mb-12 p-8 bg-zinc-900 rounded-lg shadow-lg">
      ...
      <div class="space-y-6">
        <div>
          ...
          <p class="text-lg text-zinc-300">You can book Stage Fright by contacting us via the form above or emailing us directly at <span class="text-red-400">contact@stagefrightband.com</span>.</p>
        </div>
        <div>
